...
from .models import (Dict, DictType, File, Organization, Permission, Position, Task, Tasktype,
                     Role, User)
...
from .serializers import (DictSerializer, DictTypeSerializer, FileSerializer,
                          ...
                          PositionSerializer, RoleSerializer, TaskSerializer, TasktypeSerializer,
