  ...
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogTableVisible" title="任务详细信息" >
        <el-table :data="tableData.filter(data => !search || data.task_name.toLowerCase().includes(search.toLowerCase()))"> 
            <el-table-column property="task_name" label="任务名称" width="100">
                    <template scope="scope"><span>{{ scope.row.task_name }}</span></template>
            </el-table-column>
            <el-table-column property="task_type" label="任务类型" width="100"></el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="dialogType==='edit'?'编辑岗位':'新建任务'">
      <el-form
        ref="Form"
        :model="task"
        label-width="80px"
      ...
      >
        ...
        <el-form-item label="任务类型" prop="task_type">
          <el-select v-model="task.task_type" multiple placeholder="请选择任务类型" style="width:100%">
           <el-option
        ...
        <el-form-item label="数据集" prop="task_mached_dataset">
          <el-input type = "textarea" autosize v-model="task.matched_dataset" placeholder="数据集" />
        </el-form-item>
